...
// $('#best-seller-cont').html() //GET THE HTML AT THE ID
// console.log($('#best-seller-cont').html()); // SEE WHAT WE HAVE IN THE CONSOLE
...
var darkbtn= $('nav').toggleClass("btn btn-dark navbar-dark")
