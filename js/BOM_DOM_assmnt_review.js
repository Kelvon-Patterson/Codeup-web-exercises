...
//TODO:Let's make a class - when the toggle class button- when the toggle class button is clicked, the box will change color to the class's background -color
