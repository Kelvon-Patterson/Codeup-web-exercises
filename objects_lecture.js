...
console.log("Whoops I forgot to tell y'all what year it was! " + myCarYear)
...
//What if we wanted to create a more complicated piece of data? Perhaps a list of our cars FEATURES?
  ...
  myCar.features = ["0-60 in 2.4s", "400 mile battery life", "Four-zone climate control", "Massaging front seats"]
...
//An object can also contain within itself a method (function). We can set it up similarly to our properties, but with a value that is the function expression
 ...
 myCar.turnOn = function () {
    alert("Keyless entry here just push a button and - fired up the " + myCar.make + " " + myCar.model + " just fine!")
 }
...
var sigotherCar = {
    ...
    turnOn: function  (){
        alert("Keyless entry here just push a button and - fired up the " + sigotherCar.make + " " + sigotherCar.model + " just fine!")
    }
}
